...
import com.yb.part5_chapter04.databinding.ActivityCameraBinding
import com.yb.part5_chapter04.extensions.loadCenterCrop
import com.yb.part5_chapter04.util.PathUtil
...
import com.yb.part5_chapter04.extensions.clear
import com.yb.part5_chapter04.photo.ImageListActivity.Companion.IMAGE_LIST_REQUEST_CODE
import java.io.File
    ...
    private fun bindPreviewImageViewClickListener() = with(binding) {
        previewImageView.setOnClickListener {
            startActivityForResult(
                ImageListActivity.newIntent(this@CameraActivity, uriList), IMAGE_LIST_REQUEST_CODE
            )
        }
    }
